...
**Your domain:** International co-authorship: number of distinct co-author countries per article
**Sub-family label (use exactly this for theory_family):** `collaboration-constraint`
**Complexity:** Simple
**Permitted measurement approach:** Count distinct iso3 values per wos_id — directly from corpus; no external API required
...
- Write to `teams/team_14/analysis_plan.md`:
...
- Write R code in `teams/team_14/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_14/analysis/figures/`
- Save a `teams/team_14/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_14/report/report.md`
