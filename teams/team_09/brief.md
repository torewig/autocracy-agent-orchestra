...
**Your domain:** Normative language avoidance: frequency of evaluative/normative terms (should, ought, justice, rights, freedom) per abstract
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Simple
**Permitted measurement approach:** Dictionary count of normative terms normalised by abstract length — no external API required
...
- Write to `teams/team_09/analysis_plan.md`:
...
- Write R code in `teams/team_09/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_09/analysis/figures/`
- Save a `teams/team_09/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_09/report/report.md`
