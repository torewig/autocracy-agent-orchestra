...
**Your domain:** Author count per article: whether autocracy reduces mean team size at country-year level
**Sub-family label (use exactly this for theory_family):** `collaboration-constraint`
**Complexity:** Simple
**Permitted measurement approach:** Aggregate n_authors to country-year mean — directly from corpus; no external API required
...
- Write to `teams/team_17/analysis_plan.md`:
...
- Write R code in `teams/team_17/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_17/analysis/figures/`
- Save a `teams/team_17/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_17/report/report.md`
