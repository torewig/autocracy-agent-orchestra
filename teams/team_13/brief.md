...
**Your domain:** Journal domesticity: share of SSH output published in domestic (same-country) vs. international journals
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Medium
**Permitted measurement approach:** Match journal country of publication to author country — requires constructing journal-country lookup from corpus; no external API
...
- Write to `teams/team_13/analysis_plan.md`:
...
- Write R code in `teams/team_13/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_13/analysis/figures/`
- Save a `teams/team_13/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_13/report/report.md`
