...
**Your domain:** Collectivist vs. individualist rights framing: LLM-classified share of abstracts that frame political and social phenomena in collectivist (state, nation, social harmony, public interest) vs. individualist (civil liberties, personal autonomy, individual rights) terms
**Sub-family label (use exactly this for theory_family):** `ideological-alignment`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required; three-way classifier (COLLECTIVIST / INDIVIDUALIST / MIXED-NEUTRAL) on stratified abstract sample; estimated cost $2-4
...
- Write to `teams/team_26/analysis_plan.md`:
...
- Write R code in `teams/team_26/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_26/analysis/figures/`
- Save a `teams/team_26/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_26/report/report.md`
