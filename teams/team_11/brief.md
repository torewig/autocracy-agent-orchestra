...
**Your domain:** First-person argumentative stance: rate of 'we argue / I argue / we show' phrases per abstract length
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Simple
**Permitted measurement approach:** Regex match on stance phrases normalised by abstract word count — no external API required
...
- Write to `teams/team_11/analysis_plan.md`:
...
- Write R code in `teams/team_11/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_11/analysis/figures/`
- Save a `teams/team_11/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_11/report/report.md`
