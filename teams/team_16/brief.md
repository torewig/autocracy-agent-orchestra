...
**Your domain:** Domestic-only authorship: share of articles where all author countries are the same country
**Sub-family label (use exactly this for theory_family):** `collaboration-constraint`
**Complexity:** Simple
**Permitted measurement approach:** Count distinct iso3 per wos_id; flag as domestic-only if n_distinct == 1 — no external API required
...
- Write to `teams/team_16/analysis_plan.md`:
...
- Write R code in `teams/team_16/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_16/analysis/figures/`
- Save a `teams/team_16/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_16/report/report.md`
