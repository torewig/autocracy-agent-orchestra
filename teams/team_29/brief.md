...
**Your domain:** Country-size moderation: whether the self-censorship effect is stronger or weaker in large SSH producers
**Sub-family label (use exactly this for theory_family):** `regime-channels`
**Complexity:** Simple
**Permitted measurement approach:** Interact v2x_libdem x log(e_wb_pop) or large_producer dummy — no external API required
...
- Write to `teams/team_29/analysis_plan.md`:
...
- Write R code in `teams/team_29/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_29/analysis/figures/`
- Save a `teams/team_29/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_29/report/report.md`
