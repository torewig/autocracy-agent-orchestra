...
**Your domain:** Citation gap by topic sensitivity: whether politically sensitive articles (keyword flag) from autocracies are cited less
**Sub-family label (use exactly this for theory_family):** `visibility-suppression`
**Complexity:** Medium
**Permitted measurement approach:** Combine team 04 sensitive-keyword flag logic with citation outcome; interaction model; no external API
...
- Write to `teams/team_20/analysis_plan.md`:
...
- Write R code in `teams/team_20/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_20/analysis/figures/`
- Save a `teams/team_20/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_20/report/report.md`
