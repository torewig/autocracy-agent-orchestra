...
**Your domain:** Institutional diversity: number of distinct author institutions per article
**Sub-family label (use exactly this for theory_family):** `collaboration-constraint`
**Complexity:** Medium
**Permitted measurement approach:** Parse institutions field per article — requires string splitting; no external API required
...
- Write to `teams/team_18/analysis_plan.md`:
...
- Write R code in `teams/team_18/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_18/analysis/figures/`
- Save a `teams/team_18/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_18/report/report.md`
