...
**Your domain:** Technocratic framing: share of abstracts using exclusively technical vocabulary with no political reference (LLM classifier)
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required for binary classification; stratified sample recommended
...
- Write to `teams/team_10/analysis_plan.md`:
...
- Write R code in `teams/team_10/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_10/analysis/figures/`
- Save a `teams/team_10/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_10/report/report.md`
