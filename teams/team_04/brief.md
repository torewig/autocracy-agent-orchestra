...
**Your domain:** Regime-sensitive keyword prevalence: share of articles mentioning democracy, human rights, corruption, protest
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Simple
**Permitted measurement approach:** Dictionary-based regex match on title + keywords — no external API required
...
- Write to `teams/team_04/analysis_plan.md`:
...
- Write R code in `teams/team_04/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_04/analysis/figures/`
- Save a `teams/team_04/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_04/report/report.md`
