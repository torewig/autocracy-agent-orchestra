...
**Your domain:** Autocracy type: whether closed autocracies show stronger self-censorship effects than electoral autocracies (v2x_regime 0 vs. 1)
**Sub-family label (use exactly this for theory_family):** `regime-channels`
**Complexity:** Simple
**Permitted measurement approach:** Compare v2x_regime == 0 vs. v2x_regime == 1 subgroups; interaction or subsetting — no external API
...
- Write to `teams/team_28/analysis_plan.md`:
...
- Write R code in `teams/team_28/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_28/analysis/figures/`
- Save a `teams/team_28/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_28/report/report.md`
