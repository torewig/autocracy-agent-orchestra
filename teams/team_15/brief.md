...
**Your domain:** Democratic co-authorship: co-authorship links to liberal democracies only (v2x_libdem > 0.5 in co-author country-year)
**Sub-family label (use exactly this for theory_family):** `collaboration-constraint`
**Complexity:** Medium
**Permitted measurement approach:** Identify co-author countries with v2x_libdem > 0.5; requires cross-joining article-country rows — no external API
...
- Write to `teams/team_15/analysis_plan.md`:
...
- Write R code in `teams/team_15/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_15/analysis/figures/`
- Save a `teams/team_15/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_15/report/report.md`
