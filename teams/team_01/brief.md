...
**Your domain:** Share of abstract text containing political-content keywords (PCI score), aggregated to country-year
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Simple
**Permitted measurement approach:** Dictionary-based keyword counting in abstracts — no external API required
...
- Save a `teams/team_01/analysis/primary_results.json` with fields:
