...
**Your domain:** Critical domestic governance framing: LLM-classified share of articles critically examining own-country institutions
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required (Claude Haiku or equivalent) for abstract classification; use stratified sample to manage cost
...
- Write to `teams/team_05/analysis_plan.md`:
...
- Write R code in `teams/team_05/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_05/analysis/figures/`
- Save a `teams/team_05/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_05/report/report.md`
