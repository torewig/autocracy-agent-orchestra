...
**Your domain:** Topical diversity of SSH keywords: breadth of author-supplied keyword vocabulary per country-year
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Simple
**Permitted measurement approach:** Aggregate author keywords per country-year — no external API required
...
- Write to `teams/team_02/analysis_plan.md`:
...
- Write R code in `teams/team_02/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_02/analysis/figures/`
- Save a `teams/team_02/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_02/report/report.md`
