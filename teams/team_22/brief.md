...
**Your domain:** Citation concentration: whether autocracy predicts higher Gini concentration of citations within country-year
**Sub-family label (use exactly this for theory_family):** `visibility-suppression`
**Complexity:** Simple
**Permitted measurement approach:** Compute Gini coefficient of tot_cites per country-year — requires ineq or custom Gini function; no external API
...
- Write to `teams/team_22/analysis_plan.md`:
...
- Write R code in `teams/team_22/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_22/analysis/figures/`
- Save a `teams/team_22/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_22/report/report.md`
