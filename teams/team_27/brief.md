...
**Your domain:** Protest and collective action de-legitimation: LLM-classified share of protest-related abstracts that frame collective action (protests, strikes, civil disobedience, social movements) as threats to order or stability rather than as legitimate political expression
**Sub-family label (use exactly this for theory_family):** `ideological-alignment`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required; keyword pre-filter to identify protest-related abstracts, then binary LLM classifier (LEGITIMATE vs. DE-LEGITIMATING); estimated cost $1-3
...
- Write to `teams/team_27/analysis_plan.md`:
...
- Write R code in `teams/team_27/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_27/analysis/figures/`
- Save a `teams/team_27/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_27/report/report.md`
