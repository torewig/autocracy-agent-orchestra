...
**Your domain:** Regime legitimation framing: LLM-classified share of abstracts that frame the current political system, state authority, party, or leadership as effective, stable, or beneficial (positive mirror of Team 05's critical-framing test)
**Sub-family label (use exactly this for theory_family):** `ideological-alignment`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required; binary classifier (LEGITIMATING vs. NON-LEGITIMATING) on stratified abstract sample; estimated cost $2-4
...
- Write to `teams/team_24/analysis_plan.md`:
...
- Write R code in `teams/team_24/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_24/analysis/figures/`
- Save a `teams/team_24/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_24/report/report.md`
