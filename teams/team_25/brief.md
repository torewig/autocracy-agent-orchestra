...
**Your domain:** Anti-liberal-democracy framing: LLM-classified share of abstracts that explicitly critique liberal democracy, Western political norms, international democratic institutions, or human rights as Western imposition
**Sub-family label (use exactly this for theory_family):** `ideological-alignment`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required; binary classifier (ANTI-LIBERAL vs. OTHER) on stratified abstract sample; estimated cost $2-4
...
- Write to `teams/team_25/analysis_plan.md`:
...
- Write R code in `teams/team_25/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_25/analysis/figures/`
- Save a `teams/team_25/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_25/report/report.md`
