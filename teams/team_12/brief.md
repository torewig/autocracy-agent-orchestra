...
**Your domain:** Normative conclusion claims: whether abstracts make a normative or policy claim vs. purely descriptive (LLM binary label)
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Complex
**Permitted measurement approach:** External LLM API required; focus on final sentence(s) of abstract; stratified sample
...
- Write to `teams/team_12/analysis_plan.md`:
...
- Write R code in `teams/team_12/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_12/analysis/figures/`
- Save a `teams/team_12/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_12/report/report.md`
