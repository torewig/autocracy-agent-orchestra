...
**Your domain:** Rhetorical hedging: frequency of epistemic hedging language (may, might, seem, appear, suggest) per abstract
**Sub-family label (use exactly this for theory_family):** `framing-neutrality`
**Complexity:** Simple
**Permitted measurement approach:** Dictionary count of hedging terms normalised by abstract length — no external API required
...
- Write to `teams/team_08/analysis_plan.md`:
...
- Write R code in `teams/team_08/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_08/analysis/figures/`
- Save a `teams/team_08/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_08/report/report.md`
