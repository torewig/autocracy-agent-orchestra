...
**Your domain:** Share of abstracts mentioning international funding agencies (proxy for cross-border topic permission)
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Simple
**Permitted measurement approach:** Regex/string match on acknowledgment / grant_agencies field — no external API required
...
- Save a `teams/team_07/analysis/primary_results.json` with fields:
