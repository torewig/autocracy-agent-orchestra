...
**Your domain:** Disciplinary composition: share of SSH output in politically sensitive fields (political science, law, sociology, IR)
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Simple
**Permitted measurement approach:** Classify subject_categories into sensitive vs. neutral fields — no external API required
...
- Write to `teams/team_03/analysis_plan.md`:
...
- Write R code in `teams/team_03/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_03/analysis/figures/`
- Save a `teams/team_03/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_03/report/report.md`
