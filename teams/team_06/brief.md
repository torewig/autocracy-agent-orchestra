...
**Your domain:** Semantic diversity of abstracts: pairwise cosine distance of text embeddings within country-field-year clusters
**Sub-family label (use exactly this for theory_family):** `topic-avoidance`
**Complexity:** Complex
**Permitted measurement approach:** External embedding API required (OpenAI or equivalent); use stratified sample to manage cost; estimate ~$10 for full corpus
...
- Write to `teams/team_06/analysis_plan.md`:
...
- Write R code in `teams/team_06/analysis/analysis.R` (tidyverse style)
...
- Produce 2-4 figures or tables; save to `teams/team_06/analysis/figures/`
- Save a `teams/team_06/analysis/primary_results.json` with fields:
...
- Write a 4-5 page report to `teams/team_06/report/report.md`
