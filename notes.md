...
## Data and methods
- **Corpus:** Web of Science (`DATA/bibliometric/WOS_scrapes/`), Cold War-era subset (1945–1983) — coverage decision resolved
...
## Current phase
**Phase 1 — Gate B review.** Phase 0 complete; WOS coverage decision resolved (proceeding as Cold War corpus). Gate B review document in `gate_b_review.md` / `.pdf`.
